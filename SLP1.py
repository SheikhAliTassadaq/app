...
heart_disease_prediction = pickle.load(
    open("C:/Users/SHEIKH ALI TASSADAQ/Desktop/multiple disease prediction system/saved models/heart_disease_model.pkl",
         "rb"))
parkinson_prediction = pickle.load(
    open("C:/Users/SHEIKH ALI TASSADAQ/Desktop/multiple disease prediction system/saved models/parkinson.pkl","rb"))
diabeties_prediction = pickle.load(
    open("C:/Users/SHEIKH ALI TASSADAQ/Desktop/multiple disease prediction system/saved models/trained_model.pkl",
         "rb"))
...
if (selected == parkinson_prediction):
    ...
    if st.button('Parkinson Disease Test Result'):
        pd_prediction = model.predict([[MDVP_Fhi_Hz, MDVP_Flo_Hz,MDVP_Jitter_percentage, MDVP_Jitter_Abs, MDVP_RAP, MDVP_PPQ, Jitter_DDP, MDVP_Shimmer, MDVP_Shimmer_dB, Shimmer_APQ3, Shimmer_APQ5, MDVP_APQ, Shimmer_DDA, NHR, HNR, RPDE, DFA, spread1, spread2, D2, PPE]])
...
if selected == diabeties_prediction:
    ...
    if st.button('Diabetic Diagnosis Test Result'):
        d_prediction = Classifiers.predict(
